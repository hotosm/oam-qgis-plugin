# -*- coding: utf-8 -*-
#
# OpenImageryNetwork documentation build configuration file, created by
...
latex_documents = [
  ('index', 'OpenImageryNetwork.tex', u'OpenImageryNetwork Documentation',
...
man_pages = [
    ('index', 'TemplateClass', u'OpenImageryNetwork Documentation',
